...
<html class="loading" lang="en" data-textdirection="ltr">
  <head>
    ...
    <title>Tokko</title>
    <link rel="apple-touch-icon" href="<?php echo base_url('theme-assets/images/logo/logom.png') ?>">
    <link rel="shortcut icon" type="image/x-icon" href="<?php echo base_url('theme-assets/images/logo/logom.png') ?>">
